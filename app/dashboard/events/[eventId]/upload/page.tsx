...
export default function UploadPhotos({ params }: { params: { eventId: string } }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Redirect ke halaman kelola setelah upload selesai
      setTimeout(() => {
        router.push(`/dashboard/events/${params.eventId}/manage`);
      }, 1000);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-6">
            ...
            <p className="text-lg font-medium text-gray-700 mb-2">Pilih foto untuk diupload</p>
            <p className="text-gray-500 mb-4">Format yang didukung: JPG, PNG, JPEG (Maks. 10MB per foto)</p>
          ...
          {selectedFiles.length > 0 && (
            <div className="mb-6">
              <h2 className="text-xl font-semibold mb-4">Foto yang akan diupload ({selectedFiles.length})</h2>
              
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {selectedFiles.map((file, index) => (
                  <div key={index} className="relative border rounded-lg overflow-hidden bg-gray-100">
